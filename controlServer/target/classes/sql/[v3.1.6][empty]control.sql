...
) ENGINE=InnoDB AUTO_INCREMENT=775 DEFAULT CHARSET=utf8 COMMENT='门禁开门日志表(用于记录开门次数)';
...
--
-- Table structure for table `tb_control_component`
--
...
--
-- Table structure for table `tb_control_template`
--
...
--
-- Table structure for table `tb_inspection_detail`
--
...
--
-- Table structure for table `tb_inspection_record`
--
...
--
-- Table structure for table `tb_inspection_timing`
--
...
--
-- Table structure for table `tb_multi_control`
--
...
--
-- Table structure for table `tb_place_template`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=299 DEFAULT CHARSET=utf8 COMMENT='资产报修表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_repair_assign` (
  ...
  `tenant_id` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=171 DEFAULT CHARSET=utf8 COMMENT='报修分配表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='报修评价表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_repair_result` (
  ...
  `tenant_id` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='报修结果表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_repair_update_log` (
  ...
  `deleted` tinyint(4) DEFAULT '0' COMMENT '是否被删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=319 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='报修修改记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_sk87_action` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33822 DEFAULT CHARSET=utf8 COMMENT='SK87操作表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tb_unattended_config`
--
...
-- Dump completed on 2023-01-11 10:20:01
